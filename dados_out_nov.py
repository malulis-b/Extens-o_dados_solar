...
#mapeamento meses outubro e novembro 
...
#reforçando apenas meses de out e nov 
        ...
        print(f"Erro crítico ao abrir o arquivo: {nome_arq}")

#processamento, calculo/porcentagem de lacunas e repetições 
if lista_tabelas:
...
#conversão por ordem cronologia 
...
#grafico e porcentagem 
    print("\n" + "═"*75)
    print("EXTRATO DE INTEGRIDADE DA SÉRIE TEMPORAL (OUTUBRO E NOVEMBRO)")
    print("═"*75)
    print(f"Período Real Mapeado: de {data_inicio.strftime('%d/%m/%Y %H:%M')} até {data_fim.strftime('%d/%m/%Y %H:%M')}")
